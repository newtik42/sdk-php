...
use \NewTik\TempletSDKPHP\Exception\HttpClientException;

class HttpCurl implements \NewTik\TempletSDKPHP\HttpClient\ClientInterface {
    ...
    private $options = [
        ...
        CURLOPT_USERAGENT => 'NewTik-TempletSDKPHP-sdk-php',
