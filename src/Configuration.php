...
namespace NewTik\TempletSDKPHP;

use \NewTik\TempletSDKPHP\HttpClient\ClientInterface;
...
class Configuration {
    ...
    public static function setDev() {
        //self::$ApiUrl = 'api-epdev..com';
        self::setBasicAuth("", "");        
    }
    
    private static $ApiVersion = '1';
    
    private static $ApiUrl = 'api.com';
    ...
    public static function setHttpClient($client) {
        if (is_string($client)) {
            $HttpClient = 'NewTik\\TempletSDKPHP\\HttpClient\\' . $client;
        ...
        $HttpClient = 'NewTik\\TempletSDKPHP\\HttpClient\\HttpCurl';
        return self::$HttpClient = new $HttpClient();
    }
